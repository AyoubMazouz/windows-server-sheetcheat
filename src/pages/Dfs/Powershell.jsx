...
const powershell = () => {
    return (
        <PowershellSyn>
            ...
            New-StoragePool -FriendlyName "pool1" -PhysicalDisks (Get-PhysicalDisk -CanPool $True) 
                -StorageSubsystemFriendlyName "Windows Storage*"
            ex...
            Selectionnez tous les disques physiques => Get-PhysicalDisk -CanPool $True
            Specifiez les disques physiques des sorcières => Get-PhysicalDisk 
                -FriendlyName "disk1", "disk2", "disk3"
            
            Creer un disque virtuel (Virtual disk):
            New-VirtualDisk -StoragePoolFriendlyName "pool1" -FriendlyName "disk1" -Size (50GB) 
                -ResiliencySettingName Mirror -ProvisioningType Thin
            ex...
            -ResiliencySettingName {
                "simple": les donnees sont reparties sur le disque physique, si un seul disque tombe en 
                    panne, les donnees sont perdues (disk1 = pool1) (RAID 0),
                "mirror": les donnees sont copiees entre les disques, ce n est pas grave si un disque 
                    physique tombe en panne, vous avez besoin d au moins deux disques pour selectionner 
                    cette option (disk1 < (pool1 / 2)) (RAID 1),
                "parity": utilise au moins trois disques physiques, si un disque tombe en panne, les 
                    donnees sont reconstruites et retabli (disk < (pool1 / 3)) (RAID 5)
            }
